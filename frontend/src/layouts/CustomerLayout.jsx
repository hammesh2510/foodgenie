          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                ...
                {user && (
                  <Link to="/profile" className="text-gray-500 hover:text-gray-900 px-1 pt-1 text-sm font-medium">My Orders</Link>
                )}
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <Link to="/cart" className="text-gray-500 hover:text-orange-500 relative mr-4">
